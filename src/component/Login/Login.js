    ...
    return (
        <div>
            <div>
              ...
              <form style={{ border: "2px solid gray", display: 'inline-block', margin: '5% auto', padding: '4em 3em' }} onSubmit={handleSubmit}>
                <h3>Login</h3>
          ...
          <div>
          <button style={{border:'1px solid gray'}} className="btn" onClick={handleFacebookSignIn}><FontAwesomeIcon icon={faFacebookF} style={iconStyle} />Continue with Facebook</button>
          </div>
        </div>
