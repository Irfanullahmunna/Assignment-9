                ...
                <div className="col-md-4 m-2 ">
                    {!show && <form className="d-flex justify-content-center" action="" >
                        <div style={{ border: '1px solid gray' }} className="p-5 m-2 bg-light">
                            ...
                            <br />
                            <input style={inputStyle} onBlur={handleBlur} type="dateTime-local" id="time" name="time"></input>
                            <br />
                            <button style={{ width: '100%' }} className="btn btn-danger mt-2" onClick={showVehicle} value="ffg"> Search </button>
                        </div>
                    </form>}
                    {show && <div  >
